    ...
    <div role="tabpanel" class="tab-pane" id="overdue">
		<div class='container-fluid topHeader'>
			...
			<div class='row filters'>
				<div class='offset-lg-0 col-lg-3 offset-md-0 col-md-3 offset-sm-1 col-sm-3 offset-1 col-10'>                  
				...
				<div class='offset-lg-0 col-lg-2 offset-md-0 col-md-2 offset-sm-0 col-sm-4 offset-1 col-10'>
        ...
        <div class='container-fluid'>
            <connection v-for='conn in filteredConnections' v-bind:key='conn._id' :connProp='conn' :overdue='true'  :apiURL='apiURL'></connection>
        </div>
    </div>
</template>
